import { selectModal } from "../../../store/ducks/edit/editSlice";
import { edit, getEditItem } from "../../../store/ducks/edit/editThunk";
import { useAppDispatch, useAppSelector } from "../../../store/Hooks";
import React, { useEffect, useState } from "react";
import styled from "styled-components";
import Button from "../../../styles/UI/Button";
import Notification from "../../../styles/UI/Notification/Notification";
...
const Profile = () => {
    ...
    const userInfo = useAppSelector(({ authInfo }) => authInfo.userInfo);
